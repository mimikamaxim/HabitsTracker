...
import com.example.habitstracker.data.room.HabitSQLEntity as HabitSQLEntity1
...
internal object Mapper {
    ...
    fun sqlToNewNet(habit: com.example.habitstracker.data.room.HabitSQLEntity): NetNewHabitEntity {

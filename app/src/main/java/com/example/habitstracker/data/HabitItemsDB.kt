...
object HabitItemsDB {
    ...
    fun fillDBsample() {
        addHabit(HabitItem("Читать новости", "Читать свежие новости", 5, false, 1, "Раз в день",Color.GRAY))
        addHabit(HabitItem("Физические упражнения", "Заниматься физической нагрузкой в течении часа", 5, true, 1, "Раз в неделю",Color.RED))
